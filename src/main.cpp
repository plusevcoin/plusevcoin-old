...
uint256 hashGenesisBlock("0x532603c80e590a2262a29d176d3dc7b3dd8a0b6922f60fbb8e714326cdaf6c2f");
...
const string strMessageMagic = "PlusEVCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // PlusEVCoin: Subsidy is cut in half every 1,000,000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 1000000);
    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 8 * 60 * 60; // PlusEVCoin: retarget time 8 hours
static const int64 nTargetSpacing = 120; // PlusEVCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal plusevcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PlusEVCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf1899196a13ebde43b272ad4668433839427ccf81fe7847853ffce8fca527c13");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "The Times 29/Jan/2014 Huge payoff for NHS chief who never left";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1391000000; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 510398;

        if (fTestNet)
        {
            block.nTime    = 1390900000;
            block.nNonce   = 399520;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x61145140e4cfde988c226e87c02ea33e79e90a7a1d236eac661ef33eca4c2df5"));
...
unsigned char pchMessageStart[4] = { 0xc2, 0xda, 0xf5, 0xbb };
